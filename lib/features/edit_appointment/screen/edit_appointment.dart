...
//Serching  Services base on service name and code
  ...
  getData() async {
    ...
    try {
      ...
      _nameController.text = widget.orderModer.userModel.name;
      _appointmentDateController.text = widget.orderModer.serviceDate;
      _mobileController.text = widget.orderModer.userModel.phone.toString();
...
//For time slot
  ...
  void _initializeTimes() {
    try {
      String salonOpenTime =
          timeOfDayToString(widget.orderModer.salonModel.openTime!);
      String salonCloseTime =
          timeOfDayToString(widget.orderModer.salonModel.closeTime!);
                                                    ...
                                                    ontap: () async {
                                                      ...
                                                      TimeDateModel
                                                        ...
                                                        time: GlobalVariable
                                                            .getCurrentTime(),
                                                        updateBy:
                                                            "${widget.orderModer.salonModel.name} (Appointment update)",
                                                      );
                                                      timeDateList
                                                          .add(timeDateModel);
                            ...
                            Positioned(
                              ...
                              child: SizedBox(
                                ...
                                child: CustomCalendar(
                                  salonModel: widget.orderModer.salonModel,
