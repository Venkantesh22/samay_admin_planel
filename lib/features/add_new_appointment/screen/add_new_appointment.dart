// ignore_for_file: prefer_final_fields, unused_field, unused_element, use_build_context_synchronously, no_leading_underscores_for_local_identifiers
...
//     // Ensure the last slot includes the closing time
//     String lastSlotFormattedTime = DateFormat('hh:mm a').format(_endTime!);
//     if (_categorizedTimeSlots['Night']?.isNotEmpty == true &&
//         _categorizedTimeSlots['Night']!.last != lastSlotFormattedTime) {
//       _categorizedTimeSlots['Night']!.add(lastSlotFormattedTime);
//     }
//   }
...
//                                                           UserModel(
//                                                               id:
//                                                                   adminId, // give adminId becauser fatch a appointment it need user ID not is new appointment user adminId thay why i give admin id
//                                                               name: fullName,
//                                                               phone: int.parse(
//                                                                   _mobileController
//                                                                       .text
